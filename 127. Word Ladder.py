...
class Solution(object):
            ...
            while Q:
                ...
                if word is None:
                    ...
                    for w in self.get_possible_word(word):
                        test = word_dict.get(w, float('nan'))
                        if test * flag < 0:
                            yield length + abs(test)
                        elif test == 0:
                            word_dict[w] = flag * (length + 1)
                            Q.append(w)
    ...
    def get_possible_word(self, word, abc=[chr(i) for i in range(97, 123)]):
...
if __name__ == '__main__':
    ...
    Solution().ladderLength('hot', 'dog', ["hot","dog"])
    import time
    tic = time.time()
